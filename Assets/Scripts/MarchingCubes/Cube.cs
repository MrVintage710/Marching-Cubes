...
public class Cube {
	...
	private Vertex[] verts = new Vertex[8];
	...
	public Cube(float isolevel, Vertex v0, Vertex v1, Vertex v2, Vertex v3, Vertex v4, Vertex v5, Vertex v6, Vertex v7) {
		this.v0 = v0;
		this.v1 = v1;
		this.v2 = v2;
		this.v3 = v3;
	...
	public Mesh updateMesh(float isolevel) {
		int index = 0;
		if (v0.Level < isolevel) index |= 0b00000001;
		if (v1.Level < isolevel) index |= 0b00000010;
		if (v2.Level < isolevel) index |= 0b00000100;
		if (v3.Level < isolevel) index |= 0b00001000;
		if (v4.Level < isolevel) index |= 0b00010000;
		if (v5.Level < isolevel) index |= 0b00100000;
		if (v6.Level < isolevel) index |= 0b01000000;
		if (v7.Level < isolevel) index |= 0b10000000;

		mesh.triangles = triTable[index];
		mesh.RecalculateNormals();
		return mesh;
	}

	public void update(float isolevel, Vertex v0, Vertex v1, Vertex v2, Vertex v3, Vertex v4, Vertex v5, Vertex v6, Vertex v7) {
		this.v0 = v0;
		this.v1 = v1;
		this.v2 = v2;
		this.v3 = v3;
	...
	public Vector3 MiddlePoint => v3.Pos + new Vector3(0.5f, 0.5f, 0.5f);
